export function CookiesContent() {
  return (
    <div className="max-w-3xl mx-auto prose prose-primary">
      <p>
        This Cookie Policy explains how AutoBreeze ("we", "us", and "our") uses cookies and similar technologies to
        recognize you when you visit our website at autobreeze.com ("Website"). It explains what these technologies are
      ...
      <p>
        ...
        cookies enable us to track and target the interests of our users to enhance the experience on our Website. Third
      ...
      <ul>
        ...
        <li>
          ...
          aggregate form to help us understand how our Website is being used or how effective our marketing campaigns
          are, or to help us customize our Website for you.
        </li>
        <li>
          <strong>Advertising cookies:</strong> These cookies are used to make advertising messages more relevant to
      ...
      <p>
        ...
        clicking on the appropriate opt-out links provided in the cookie banner or privacy preference center.
      </p>
      <p>
